...
public class AppInfoDashboardFragment extends DashboardFragment
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (com.android.internal.crystal.util.CrystalUtils.isPackageInstalled(mContext,"com.android.vending")) {
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (com.android.internal.crystal.util.CrystalUtils.isPackageInstalled(getContext(),"com.android.vending")) {
